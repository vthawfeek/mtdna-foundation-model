...
- Day 17: COMPLETE — pathogenic variant prediction (MtDNAForVariantPathogenicity, variant-token hidden state, LoRA r=4, pos_weight=2.5, PathogenicityVariantDataset, 274 tests)
- Day 18-21: heteroplasmy regression + evaluation + HuggingFace Hub
